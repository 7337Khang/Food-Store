    ...
    <div style={{ paddingTop: "10px" }}>
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="my-3">
            <h2>
              <Badge bg="info">Best Seller Food</Badge>
            </h2>
            {summary.foodSold.length === 0 ? (
              <div className="error">No Food Sold</div>
            ) : (
              <Chart
                ...
                data={[
                  ["Foods", "Quantity Sold"],
                  ...summary.foodSold.map((x) => [x.name, x.quantitySold]),
                ]}
                options={{
                  colors: ["#32a673"],
                }}
          ...
          <div className="my-3">
            ...
            {summary.foodCategories.length === 0 ? (
              ...
              <Chart
                ...
                data={[
                  ["Category", "Foods"],
                  ...summary.foodCategories.map((x) => [x._id, x.count]),
                ]}
              ></Chart>
            )}
          </div>
