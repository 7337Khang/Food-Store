      ...
      >
        ...
        >
          ...
          <MenuItem component={<Link to="/forum" />}>
            <div className="fas fa-newspaper" /> News
          </MenuItem>
          ...
          <SubMenu
            label="Categories"
            icon={<strong className="fas fa-pizza-slice"></strong>}
            rootStyles={{
              ["& > ." + menuClasses.button]: {
                backgroundColor:
                  "linear-gradient(276deg, rgba(54,199,201,1) 0%, rgba(71,109,212,1) 25%, rgba(173,212,94,1) 75%, rgba(215,174,88,1) 100%)",
          ...
          {userInfo && userInfo.isAdmin && (
            ...
            >
              ...
              <LinkContainer to="/admin/foods">
                <MenuItem>
                  <div className="fas fa-hamburger" /> Products
                </MenuItem>
              </LinkContainer>
